    ...
    <div className={cn("space-y-6", className)}>
      ...
      {activeSubTab === 'backtesting' && backtestingData && (
        <div className="space-y-6">
          ...
          {backtestingData.aggregate.total_predictions_analyzed === 0 ? (
            <div className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-lg p-8 text-center">
              <div className="w-16 h-16 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center mx-auto mb-4">
                <BarChart3 className="w-8 h-8 text-gray-400" />
              </div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">
                No Backtesting Data Yet
              </h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4 max-w-lg mx-auto">
                Backtesting results will appear here once predictions have been made and outcomes can be tracked over time.
              </p>
              <div className="bg-white dark:bg-gray-800 rounded-lg p-4 max-w-md mx-auto text-left">
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">To see backtesting results:</h4>
                <ul className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                  <li>1. Upload employee data and train a model</li>
                  <li>2. Run predictions on your employees</li>
                  <li>3. Wait for outcomes to be recorded over time</li>
                </ul>
              </div>
            </div>
          ) : (
